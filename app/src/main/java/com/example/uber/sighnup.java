...
users Users=new users(e1_name.getText().toString(),e2_email.getText().toString(),e3_password.getText().toString());
...
Intent i=new Intent(sighnup.this,MainActivity.class);
                        startActivity(i);
                 finish();
                    }
